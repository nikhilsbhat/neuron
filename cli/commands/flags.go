...
func registerFlags(cmd *cobra.Command) {
	...
	cmd.PersistentFlags().BoolVarP(&neu.GetRaw, "filter", "", false, "enable this flag if you prefer to get filtered response, filtered result will give you a crisp information of the resource unlike raw output")
