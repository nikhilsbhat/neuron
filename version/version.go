// This package powers the versioning of the application.
package version
...
// The function returns the version with variant, and the value will be used to bersion the application.
// The same version will be displayed at both CLI and app(API).
func GetVersion() string {
	var versionString bytes.Buffer
	fmt.Fprintf(&versionString, "%s", versn)
	if env != "" {
