// This will make a call whether this tool supports the passed cloud.
package support
...
// This method is where the actual decision is made and will return its status as output.
