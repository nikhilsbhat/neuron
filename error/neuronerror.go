...
const (
	...
	configNotValid      = "Oops..! An error occured while reading config file you passed, the configuration file provided is not vaild. Please provide a valid json"
	configNotFound      = "I couldn't find any config file by namr which you mentioned"
	configDataBase      = "Oops..! An error occured while configuring databse with neuron, check application log (path/to/log/neuronapp.log) for more"
	dbNotConfigured     = "Oops..! the action cannot be completed as database/filesystem to data is not configured"
	decodeJsonError     = "Oops..! An error occured while decoding the json to datastructure"
	dbSessionError      = "Oops..! An error occured while establishig session to database"
	dirCreateError      = "Oops..! An error occured while creating directory"
	errInvalidParent    = "Invalid Parent"
	logpathNotFound     = "Could not find logpath in the configuration you passed"
	uilogCreationError  = "Oops..!! An error occured while creating a UI logfile"
	uiLogOpenError      = "Oops..!! An error occured while opening UI log file"
	logCreationError    = "Oops..!! An error occured while creating a neuron logfile"
	logOpenError        = "Oops..!! An error occured while opening neuron log file"
	logDirError         = "Oops..!! An error occured while creating a neuron log directory"
	...
	readFilError        = "Oops..!! An error occured while reading a file, either file is not valid no sufficient permission to open it"
